...
public abstract class MessageKeys {
    ...
    public static final String NOT_FOUND_BY_ID = "service.notFoundBookById";
    public static final String DB_ERROR = "service.DbError";
    ...
    public static final String SERVICE_LIST_EMPTY = "service.listEmpty";
    ...
    public static final String SERVICE_ADD_AUTHOR = "service.addAuthor";
    public static final String SERVICE_EDIT_BOOK = "service.editBook";
    public static final String SERVICE_EDIT_AUTHOR = "service.editAuthor";
    public static final String SERVICE_DELETE_BOOK = "service.deleteBook";
    public static final String SERVICE_DELETE_AUTHOR = "service.deleteAuthor";
}
